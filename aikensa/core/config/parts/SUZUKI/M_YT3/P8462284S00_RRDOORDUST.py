...
with open(specs_yaml_path, 'r') as f:
    ...
    part_spec = all_specs['parts']['P8462284S00']
...
pitchSpec = part_spec.get('pitchSpec', [12, 128, 128, 128, 128, 128, 128, 12, 792])
idSpec = part_spec.get('idSpec', [0, 0, 0, 0, 0, 0, 0])
tolerance_pitch = part_spec.get('tolerance_pitch', [1.7] * 9)
...
segmentation_width = part_spec.get('segmentation_width', 1640)
pixelMultiplier = part_spec.get('pixelMultiplier', 0.16097859)
