...
with open(specs_yaml_path, 'r') as f:
    ...
    part_spec = all_specs['parts']['P828387YA0A']
...
pitchSpec = part_spec.get('pitchSpec', [14.8, 108, 128, 128, 128, 128, 128, 137, 14.8, 914.6])
idSpec = part_spec.get('idSpec', [0, 0, 0, 0, 0, 0, 0, 0])
